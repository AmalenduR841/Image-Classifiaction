...
# Load the model
loaded_model = tf.keras.models.load_model(r'C:\Users\hp\OneDrive\Pictures\image classification\Model')

# Specify the path to the image you want to make predictions on
image_path = r'C:\Users\hp\OneDrive\Pictures\image classification\images\maria_1.png'
